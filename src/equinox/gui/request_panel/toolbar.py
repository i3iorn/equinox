...
class TabToolbar(QWidget):
    ...
    def __init__(
        ...
        *,
        presets: Optional[Iterable[Optional[Tuple[str, str, str]]]] = None,
        ...
        self._enable_btn.clicked.connect(self.enable_all_clicked.emit)
        ...
        self._disable_btn.clicked.connect(self.disable_all_clicked.emit)
        ...
        if presets:
            ...
            for preset in presets:
                if preset is None:
                    ...
                    act = presets_menu.addAction(display)
                    act.triggered.connect(
                        lambda _checked, k=key, v=value: self.preset_selected.emit(k, v)
                    )
        ...
        if include_file_btn:
            ...
            self._file_btn.clicked.connect(self.file_browse_clicked.emit)
