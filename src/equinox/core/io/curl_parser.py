...
def _consume_value(tokens: List[str], index: int) -> Tuple[Optional[str], int]:
...
def _consume_method_header_or_data(tok: str, tokens: List[str], index: int, state: _ParserState) -> Optional[int]:
...
def _consume_json_or_auth(tok: str, tokens: List[str], index: int, state: _ParserState) -> Optional[int]:
