"""Rotation helper moved from core.secrets_rotator.py to core.security."""

from __future__ import annotations

from typing import Optional

from equinox.core.security.secrets_password import rotate_all_secrets as _rotate_all_secrets
