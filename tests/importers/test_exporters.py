...
from equinox.importers._utils import json_to_dict, parse_url_parts, write_json_file
...
class TestPostmanExporter:
    ...
    def test_export_with_path_params(self, db):
        ...
        req = Request(method="GET", url="https://api.example.com/users/{id}", name="Get User")
...
class TestOpenAPIExporter:
    ...
    def test_export_with_auth_schemes(self, db):
        ...
        req = Request(method="GET", url="https://api.example.com/secure", name="Secure Endpoint")
        mgr.save_request(req, col_id)
