...
class TestHTTPClientParameters:
    ...
    def test_params_encoding(self):
        ...
        params = {"key": "value", "special": "hello world", "unicode": "café"}
...
class TestHTTPClientValidation:
    ...
    def test_invalid_method_raises(self):
        ...
        with pytest.raises((ValidationError, ValueError)):
            ...
            if req.method and req.method.upper() not in [
                "GET",
                "POST",
                "PUT",
                "DELETE",
    ...
    def test_validate_request_uses_path_params_and_body_content_type(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "equinox.core.validation.Validator.validate_resolved_url",
            lambda value: calls.append(("url", value)),
        )
        monkeypatch.setattr(
            "equinox.core.validation.Validator.validate_method",
            lambda value: calls.append(("method", value)),
        )
        monkeypatch.setattr(
            "equinox.core.validation.Validator.validate_headers",
            lambda value, strict=False: calls.append(("headers", strict, dict(value))),
        )
        monkeypatch.setattr(
            "equinox.core.validation.Validator.validate_query_params",
            lambda value: calls.append(("params", dict(value))),
        )
        monkeypatch.setattr(
            "equinox.core.validation.Validator.validate_request_body",
            lambda body, content_type: calls.append(("body", body, content_type)),
        )
